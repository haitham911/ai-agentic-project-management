...
agent = RAGKnowledgePromptAgent(api_key, persona, chunk_size=500, chunk_overlap=200)
...
PROMPTS = [
    ...
    "Who are Clara's parents and where are they from?",
]


def main():
    print("=== RAGKnowledgePromptAgent ===")
    print("Chunking and embedding knowledge corpus...\n")
...
run_with_tee("rag_agent.txt", main)
